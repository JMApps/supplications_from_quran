            ...
            children: [
              Container(
                ...
                child: Text(
                  item.ayahArabic,
                  style: TextStyle(
                    color: currentBrightness == Brightness.light ? Color(readSettings.getTextAyahArabicColor) : Colors.white,
              ...
              Container(
                ...
                child: Text(
                  ...
                  style: TextStyle(
                    color: currentBrightness == Brightness.light ? Color(readSettings.getTextAyahTranslationColor) : Colors.grey,
