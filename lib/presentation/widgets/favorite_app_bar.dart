...
class FavoriteAppBar extends StatelessWidget {
  ...
  static const String iosLink =
      'https://apps.apple.com/ru/app/%D0%BC%D0%BE%D0%BB%D1%8C%D0%B1%D1%8B-%D0%B8%D0%B7-%D0%BA%D0%BE%D1%80%D0%B0%D0%BD%D0%B0/id1578687261';
    ...
    return AppBar(
      ...
      actions: [
        IconButton(
          ...
          onPressed: () {
            Share.share(
                'Рекомендую скачать «Мольбы из Корана»:\n\nВерсия iOS: $iosLink\n\nВерсия android: $androidLink');
          },
        ),
